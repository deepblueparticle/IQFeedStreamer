#pragma once
#ifndef __WS2_TCPIP__
#define __WS2_TCPIP__
#include <WS2tcpip.h>
#endif // !__WS2_TCPIP__
...
#endif // !__WS2_32_LIB__

#ifndef __TCPSTREAM__
#define __TCPSTREAM__
#include "TCPStream.h"
#endif // !__TCPSTREAM__
...
public:
	...
	T* create_stream(int port, std::string ipAddress, bool verbose);
